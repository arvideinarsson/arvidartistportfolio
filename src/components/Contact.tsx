    ...
    <div className={cn('text-white py-12 md:py-20', className)}>
      <div className="w-full max-w-4xl mx-auto px-4">
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          transition={{
            duration: ANIMATION_CONFIG.defaultDuration + 0.2,
